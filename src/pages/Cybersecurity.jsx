...
const Cybersecurity = () => {
  ...
  const services = [
    {
      ...
      desc: "Real-time monitoring and AI-driven threat detection to identify and stop cyber attacks instantly.",
      icon: Activity,
    },
    {
      title: "Network Security",
      desc: "Secure your infrastructure with firewalls, intrusion detection systems, and zero-trust architecture.",
      icon: Network,
    },
    {
      title: "Data Protection",
      desc: "Advanced encryption and backup strategies to safeguard sensitive business data.",
      icon: Database,
    },
    {
      title: "Security Audits",
      desc: "Comprehensive vulnerability assessments and penetration testing to uncover risks.",
      icon: ShieldCheck,
    },
  ];
  ...
  const projects = [
    {
      title: "Enterprise Threat Monitoring System",
      desc: "Built a real-time threat detection platform that reduced cyber incidents by 90%.",
      image:
        "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=2070",
      tech: ["SIEM", "Python", "Elastic Stack", "AI Models"],
    },
    {
      title: "Zero Trust Security Architecture",
      desc: "Implemented a zero-trust framework securing internal systems and preventing unauthorized access.",
      image:
        "https://images.unsplash.com/photo-1563986768609-322da13575f3?q=80&w=2070",
      tech: ["Azure Security", "IAM", "Firewall", "Encryption"],
    },
    {
      title: "Ransomware Protection System",
      desc: "Developed an automated backup and ransomware defense solution for enterprise clients.",
      image:
        "https://images.unsplash.com/photo-1510511459019-5dda7724fd87?q=80&w=2070",
      tech: ["Backup Systems", "Cloud Security", "Linux", "Monitoring Tools"],
    },
  ];
  ...
  const yourData = [
    {
      quote:
        "Their cybersecurity solution protected us from multiple attack attempts without any downtime.",
      name: "Ali Hassan",
      designation: "CTO @ FinSecure",
      src: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=1374",
    },
    {
      quote:
        "We achieved complete network visibility and control after implementing their security system.",
      name: "Ayesha Malik",
      designation: "IT Manager @ EnterpriseX",
      src: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=1374",
    },
    {
      quote:
        "Our company is now fully protected against ransomware and data breaches.",
      name: "Usman Tariq",
      designation: "CEO @ SecureTech",
  ...
  const tabs = [
    {
      ...
      content: {
        ...
        desc: "Identify vulnerabilities and risks across your systems.",
        points: [
    ...
    },
    {
      title: "Protection",
      content: {
        heading: "Threat Prevention",
        desc: "Implementing proactive defenses against cyber threats.",
        points: [
          "Firewalls & IDS",
          "Endpoint Security",
          "Access Control",
    ...
    },
    {
      ...
      content: {
        ...
        desc: "Monitoring systems to detect suspicious activities in real-time.",
        points: [
          "SIEM Systems",
          "Log Monitoring",
          "AI Threat Detection",
    ...
    },
    {
      ...
      content: {
        ...
        desc: "Quick response and recovery from cyber attacks.",
        points: [
          "Incident Handling",
          "Disaster Recovery",
          "Backup Systems",
  ...
  const faqs = [
    {
      question: "How do you protect against cyber attacks?",
      answer:
        "We use multi-layered security including firewalls, AI-based threat detection, encryption, and continuous monitoring.",
    },
    {
      question: "What is a security audit?",
      answer:
        "A security audit evaluates your systems to identify vulnerabilities and ensure compliance with security standards.",
    },
    {
      question: "Can you prevent ransomware attacks?",
      answer:
        "Yes. We implement backup strategies, endpoint protection, and behavior-based detection to prevent ransomware.",
    },
    {
      question: "Do you offer 24/7 monitoring?",
      answer:
        "Yes. Our systems provide continuous monitoring with real-time alerts and incident response.",
    },
  ];
      ...
      >
        <div className="z-50 max-w-2xl w-full">
          <h1 className="font-sans text-white text-3xl md:text-5xl font-black leading-tight">
            Cybersecurity <span className="text-secondery">Solutions</span>
          </h1>
          <p className="mt-4 text-gray-300 text-sm md:text-base sm:max-w-xl max-w-sm font-sans">
            Protect your business from evolving cyber threats with advanced
            security systems, real-time monitoring, and enterprise-grade
      ...
      <section className="py-40 px-6 bg-[#00042A]">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-20 lg:items-center text-white">
          ...
          <div className="lg:w-1/2 space-y-2">
            ...
            <h2 className="md:text-5xl text-3xl font-black italic uppercase tracking-tighter leading-[0.8] mb-8">
              The <br />{" "}
