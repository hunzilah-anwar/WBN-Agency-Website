  ...
  return (
    <div className="relative w-full rounded-4xl overflow-hidden border border-white/10 shadow-2xl bg-black/40 backdrop-blur-xl">
      <div className="grid lg:grid-cols-2">
        ...
        <div className="sm:p-12 p-4 flex flex-col justify-center space-y-6">
          <AnimatePresence mode="wait">
            <motion.div
              key={index}
...
const SoftwareDevelopment = () => {
  ...
  const services = [
    {
      ...
      desc: "End-to-end tailored software solutions built for your business needs and scalability.",
      icon: Cpu,
    },
    {
      title: "Web Applications",
      desc: "High-performance web apps using modern frameworks with responsive and scalable architecture.",
      icon: Layers,
    },
    {
      title: "Mobile Apps",
      desc: "Cross-platform mobile applications for iOS and Android with seamless UX/UI.",
      icon: Smartphone,
    },
    {
      title: "API Development",
      desc: "Secure and scalable REST & GraphQL APIs for seamless system integration.",
      icon: DatabaseZap,
    },
  ];
  ...
  const projects = [
    {
      ...
      desc: "Built a full ERP system for business operations, HR, and finance automation.",
      image:
    ...
    },
    {
      ...
      desc: "Developed a scalable online shopping platform with payment integration and admin dashboard.",
      image:
    ...
    },
    {
      ...
      desc: "Secure messaging app with real-time communication and media sharing features.",
      image:
        "https://images.unsplash.com/photo-1611746872915-64382b5c76da?q=80&w=2070",
  ...
  const yourData = [
    {
      quote:
        "They built our entire business platform from scratch — fast, scalable, and perfectly designed.",
      name: "Hassan Ali",
    ...
    {
      quote:
        "Our software efficiency improved drastically after their system upgrade and optimization.",
      name: "Sara Khan",
      designation: "Product Manager @ DigitalCorp",
      src: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=1374",
    },
    {
      quote:
        "Highly professional team — delivered enterprise-grade software ahead of schedule.",
      name: "Usman Tariq",
      designation: "Founder @ SoftSolutions",
  ...
  const tabs = [
    {
      ...
      content: {
        ...
        desc: "Understanding business needs and defining software architecture.",
        points: [
    ...
    },
    {
      ...
      content: {
        ...
        desc: "Writing clean, scalable, and efficient code for applications.",
        points: [
    ...
    },
    {
      ...
      content: {
        ...
        desc: "Ensuring software is bug-free, stable, and production-ready.",
        points: [
          "Unit Testing",
          "Integration Testing",
          "Performance Testing",
    ...
    },
    {
      title: "Deployment",
      content: {
        heading: "Release & Maintenance",
        desc: "Deploying software and providing long-term support.",
        points: [
          "Cloud Deployment",
          "CI/CD Pipelines",
          "Monitoring",
  ...
  const faqs = [
    {
      ...
      answer:
        "Small projects take 2–6 weeks, while complex enterprise systems may take 2–6 months depending on scope.",
    },
    {
      question: "Which technologies do you use?",
      answer:
        "We use modern stacks like React, Node.js, Python, .NET, Flutter, and cloud platforms like AWS & Azure.",
    },
    {
      question: "Can you build scalable systems?",
      answer:
        "Yes. We design software with scalable architecture to handle growth and high traffic.",
    },
    {
      question: "Do you provide post-launch support?",
      answer:
        "Absolutely. We offer maintenance, updates, bug fixing, and continuous improvements.",
    },
  ];
      ...
      >
        <div className="z-50 max-w-2xl w-full">
          <h1 className="font-sans text-white text-3xl md:text-5xl font-black leading-tight">
            Software <span className="text-secondery">Development</span>
          </h1>
          <p className="mt-4 text-gray-300 text-sm md:text-base sm:max-w-xl max-w-sm font-sans">
            Build powerful, scalable, and modern software solutions tailored to
            your business needs — from web apps to enterprise systems.
          </p>
