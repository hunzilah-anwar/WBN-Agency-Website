...
const CloudSolutions = () => {
  ...
  const services = [
    {
      ...
      desc: "Seamlessly move your applications and data to secure cloud infrastructure with zero downtime.",
      icon: Cloud,
    },
    {
      title: "DevOps & Automation",
      desc: "CI/CD pipelines, infrastructure as code, and automated deployments for faster delivery.",
      icon: Terminal,
    },
    {
      title: "Cloud Security",
      desc: "Advanced threat protection, encryption, and compliance for enterprise-grade security.",
      icon: ShieldCheck,
    },
    {
      title: "Scalable Architecture",
      desc: "Auto-scaling cloud systems designed to handle millions of users efficiently.",
      icon: Server,
    },
  ];
  ...
  const projects = [
    {
      ...
      desc: "Migrated a legacy enterprise system to AWS cloud, reducing infrastructure costs by 60%.",
      image:
        "https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=2072",
      tech: ["AWS", "Docker", "Kubernetes", "Terraform"],
    },
    {
      title: "High-Availability SaaS Platform",
      desc: "Built a multi-region cloud architecture ensuring 99.99% uptime for a SaaS product.",
      image:
        "https://images.unsplash.com/photo-1518779578993-ec3579fee39f?q=80&w=2070",
      tech: ["Azure", "Load Balancer", "Redis", "Node.js"],
    },
    {
      title: "DevOps Automation System",
      desc: "Implemented CI/CD pipelines reducing deployment time from hours to minutes.",
      image:
        "https://images.unsplash.com/photo-1555949963-aa79dcee981c?q=80&w=2070",
      tech: ["GitHub Actions", "Docker", "Jenkins", "Linux"],
    },
  ];
  ...
  const yourData = [
    {
      quote:
        "Our cloud migration was flawless — downtime was practically zero and performance doubled instantly.",
      name: "Ahmed Raza",
    ...
    {
      quote:
        "Their DevOps automation reduced our deployment time by 80%. Truly game-changing.",
      name: "Sara Khan",
      designation: "Head of Engineering @ SaaSify",
      src: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=1374",
    },
    {
      quote:
        "We now run on a fully scalable cloud infrastructure that handles traffic spikes effortlessly.",
      name: "Usman Ali",
  ...
  const tabs = [
    {
      ...
      content: {
        ...
        desc: "Analyzing your current infrastructure and planning the cloud strategy.",
        points: [
    ...
    },
    {
      ...
      content: {
        ...
        desc: "Moving applications, databases, and workloads to the cloud.",
        points: [
          "Lift & Shift",
          "Re-architecture",
          "Database Migration",
    ...
    },
    {
      ...
      content: {
        ...
        desc: "Deploying scalable and resilient cloud environments.",
        points: [
          "CI/CD Pipelines",
          "Containerization",
          "Auto Scaling",
  ...
  const faqs = [
    {
      ...
      answer:
        "It depends on system complexity. Small systems take a few weeks, while enterprise migrations may take 2–3 months.",
    },
    {
      question: "Which cloud platform should I choose?",
      answer:
        "We help you choose between AWS, Azure, or Google Cloud based on your business needs and budget.",
    },
    {
      question: "Is cloud secure for my business?",
      answer:
        "Yes. We implement enterprise-grade security, encryption, and compliance standards to protect your data.",
    },
    {
      question: "Can you optimize my cloud costs?",
      answer:
        "Absolutely. We continuously monitor usage and optimize resources to reduce unnecessary expenses.",
    },
  ];
      ...
      >
        <div className="z-50 max-w-2xl w-full">
          <h1 className="font-sans text-white text-3xl md:text-5xl font-black leading-tight">
            Cloud <span className="text-secondery">Solutions</span>
          </h1>
          <p className="mt-4 text-gray-300 text-sm md:text-base sm:max-w-xl max-w-sm font-sans">
            Scale your business with secure, high-performance cloud
            infrastructure, DevOps automation, and cost-optimized deployment
            strategies.
          </p>
